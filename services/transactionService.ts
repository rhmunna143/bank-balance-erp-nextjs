...
export async function processDeposit(params: any) {
  ...
  const txn = await prisma.transaction.create({
    data: {
      ...
      customerAccount: params.customer_account_no || params.customer_account || null,
      motherAccountId: params.mother_account_id,
      profitAccountId: profitAccountId,
      reference: params.reference || null,
      trnId: params.trn_id || null,
      notes: params.description || params.notes || null,
...
export async function processExpense(params: any) {
  ...
  const expense = await prisma.expense.create({
    data: {
      ...
      description: params.particulars || params.description || null,
